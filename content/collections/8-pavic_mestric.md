...
{{< q-figure-group id="8.9a, 8.9b" pdf="two-column" label="false" caption="**Figure 8.9.** Comparison of the analogue and digital projects of two slides, a black and white (top) and a collage (bottom). Different filters were tested to reduce the color variance between the analogue and digital projection." >}}
